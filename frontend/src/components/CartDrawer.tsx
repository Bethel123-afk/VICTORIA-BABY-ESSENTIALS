            ...
            <div className="cart-drawer" onClick={(e) => e.stopPropagation()}>
                ...
                {cartItems.length > 0 && (
                    <div className="cart-drawer-footer">
                        ...
                        <button onClick={() => { onClose(); navigate('/shop'); }} className="btn btn-secondary checkout-btn" style={{ width: '100%', background: 'var(--white)', color: 'var(--primary)', border: '1px solid var(--gray-200)' }}>Continue Shopping</button>
                    </div>
                )}
            </div>
        </div>
